...
Class Admin_Settings_Page{
    ...
    public function optim_add_settings_page() {
	    add_options_page( 'Infinite Scroll in Media Library', 'Media Infinite Scroll', 'manage_options', 'optim-infinite-scroll', array( $this, 'optim_is_settings' ) );
	}
	...
	{
		echo '<div class="wrap">
		<h1>Enable Infinite Scroll In Media Library</h1>
		...
		<hr/>
	        ...
	        <div class="info-right" style="display: inline-block; margin-left: 2em;">
	            <h2><b>Optim Infinite Scroll for Media Library</b></h2>
	            <p>
	                <b>Installed Version: v' . OPTIM_INFINITE_SCROLL_MEDIA_LIBRARY . '</b><br>
	                 Website: <a target="_blank" href="https://www.facebook.com/optimtechstudio">Facebook</a>,
	                ...
	                <br>Please contact us on <a href="mailto:infinitescroll@optimtechstudio.com">infinitescroll@optimtechstudio.com</a> to get in touch.
	            </p>
	        </div>
	        <hr/>
	    </div>';
	...
	public function optim_infinite_scroll_settings_section(){
		...
		echo '<input type="radio" ' . ( '1' == $optim_is_choice ? 'checked' : '' ) . ' name="optim_is_choice" value="1" /> Enable
		<input type="radio" ' . ( '0' == $optim_is_choice ? 'checked' : '' ) . ' name="optim_is_choice" value="0" /> Disable';
	}
